...
if ($op == 'delete') {
  $id         = $_GET['id'];
  $sql1       ="delete from surat_dinas_masuk where id = '$id'";
...
if($op =='edit'){
  $id   = $_GET['id'];
  $sql1 = "select * from surat_dinas_masuk where id ='$id'";
  $q1   = mysqli_query($koneksi,$sql1);
...
if(isset($_POST['simpan'])){ //untek create
    ...
    if( $tanggal_terima_surat && $nomor_surat && $tanggal_surat && $sifat_surat && $isi_ringkasan && $dari && $kepada && $keterangan && $berkas){
       if($op =='edit'){//untk update
        $sql1     ="update surat_dinas_masuk set tanggal_terima_surat ='$tanggal_terima_surat',nomor_surat ='$nomor_surat',tanggal_surat='$tanggal_surat',sifat_surat ='$sifat_surat',isi_ringkasan ='$isi_ringkasan',dari ='$dari',kepada ='$kepada',keterangan ='$keterangan',berkas='$berkas' where id ='$id'";
        $q1       =mysqli_query($koneksi,$sql1);
        if($q1){
        ...
        $sql1 = "insert into surat_dinas_masuk (tanggal_terima_surat,nomor_surat,tanggal_surat,sifat_surat,isi_ringkasan,dari,kepada,keterangan,berkas) values ('$tanggal_terima_surat','$nomor_surat','$tanggal_surat','$sifat_surat','$isi_ringkasan','$dari','$kepada','$keterangan','$berkas')";
      $q1   = mysqli_query($koneksi,$sql1);
      if($q1){
...
header("refresh:3;url=index.php");//5 detik   
  ...
  <div class="mb-3 row">
    <label for="nama" class="col-sm-2 col-form-label">Dari</label>
    <div class="col-sm-10">
...
<div class="card">
  ...
  <div class="card-body">
   <a class="d-flex justify-content-end" target="_blank" href="cetak.php"><button type="button" class="btn btn-primary ">Print</button></a>
   <table class="table">
   <thead>
    <tr>
    <th scope="col">No</th>
