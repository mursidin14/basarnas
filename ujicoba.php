...
if(isset($_POST['simpan'])){ //untek create
    ...
    move_uploaded_file($_FILES['berkas']['tmp_name'],$direktori.$file_name);
    mysqli_query($koneksi,"insert into surat_keluar set file='$file_name'");
...
<?php
  header("refresh:0;url=ujicoba.php");//5 detik    
}
    ?>
    <?php
    if($sukses){
